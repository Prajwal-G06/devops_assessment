...
1. After the EC2 instance is created, wait 2–5 minutes before connecting.
...
➡️ Simply disconnect and reconnect to the EC2 instance one or two times.
...
### Troubleshooting steps will be found in the **DevOps.md**, Please refer there.
